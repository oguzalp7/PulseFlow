...
const Sidebar = () => {
    ...
    const roles_en = ["Basic", "Standard User", "Dealer", "La Vittoria Staff", "La Vittoria Developer"];
    const roles_tr = ["Basit", "Standart Kullanıcı", "Teknik Bayii", "La Vittoria Personel", "La Vittoria Geliştirici"];
